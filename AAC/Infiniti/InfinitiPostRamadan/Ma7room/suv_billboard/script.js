...
addListeners = function (){
	...
	exit_btn2.addEventListener('mouseover', onExpandHandler, false);
	...
	function(){
		...
		timer = setInterval(addEvent, 200);
	});
}
...
onExpandHandlerSlimbar = function(e){
	...
	exit_btn2.addEventListener('mouseout', addMouseOver, false);
}

onExpandHandler = function(e){
	exit_btn2.removeEventListener('mouseover', onExpandHandler);
	exit_btn2.addEventListener('mouseover', onSetExpandable, false);
...
addMouseOver = function() {
	exit_btn2.removeEventListener('mouseout', addMouseOver);
	exit_btn2.addEventListener('mouseover', onExpandHandler, false);
}

onSetExpandable = function() {
	expandable = false;
}

addEvent = function() {
	clearInterval(timer);
	exit_btn2.removeEventListener('mouseover', onSetExpandable);
	if (expandable) {
		exit_btn2.addEventListener('mouseover', onExpandHandler, false);
	} else {
		exit_btn2.addEventListener('mouseout', addMouseOver, false);
...
init1 = function() {
	...
	t1.to(bg, 0.5, {autoAlpha: 1})
	  ...
	  .to([sub3, sub4], 0.5, {autoAlpha: 0, delay: 2})
	  .to(cta, 0.5, {autoAlpha: 1, ease: Power2.easeOut})
	  .to(tc, 0.5, {autoAlpha: 1, ease: Power2.easeOut});
}
