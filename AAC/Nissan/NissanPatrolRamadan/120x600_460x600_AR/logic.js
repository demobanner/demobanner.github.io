 ...
 */
function init() {
  Enabler.setExpandingPixelOffsets(340, 0, 460, 600);
...
function init1() {
  tl1.to(f2_text1, 0.5, {autoAlpha:1, ease:Power3.easeInOut})
    ...
    .fromTo(f3_car1, 0.5, {autoAlpha:1, x:-150, y:-10}, {x:-22, y:0, ease:Power1.easeInOut})
    .to(wheels1, 0.1, {autoAlpha:0, ease:Power1.easeInOut}, "-=0.1")
    .to(wheels1, 0.1, {autoAlpha:1, ease:Power1.easeInOut}, "+=1")
    .to(f3_car1, 0.5, {x:120, y:10, ease:Power1.easeInOut})
    ...
    .fromTo(f3_car1, 0.5, {autoAlpha:1, x:-150, y:-10}, {x:-22, y:0, ease:Power1.easeOut})
    .to(wheels1, 0.1, {autoAlpha:0, ease:Power1.easeInOut}, "-=0.1")
    .to(f2_text1, 0, {y:-245}, "-=0.1")

    .to(f2_text1, 0.5, {autoAlpha:1, ease:Power3.easeInOut})
  ...
  tl1.fromTo(stars1, 13, {x:-203}, {x:-82, ease:Linear.easeNone}, '0')
}
...
function init2() {
  tl2.to(f2_text2, 0.5, {autoAlpha:1, ease:Power3.easeInOut})
    ...
    .fromTo(f3_car2, 0.5, {autoAlpha:1, x:-460, y:-30}, {x:0, y:0, ease:Power1.easeInOut})
    .to(wheels2, 0.1, {autoAlpha:0, ease:Power1.easeInOut}, "-=0.1")
    .to(wheels2, 0.1, {autoAlpha:1, ease:Power1.easeInOut}, "+=1")
    .to(f3_car2, 0.5, {x:460, y:30, ease:Power1.easeInOut})
    ...
    .fromTo(f3_car2, 0.5, {autoAlpha:1, x:-460, y:-53}, {x:0, y:-23, ease:Power1.easeOut})
    .to(wheels2, 0.1, {autoAlpha:0, ease:Power1.easeInOut}, "-=0.1")
  ...
  tl2.fromTo(stars2, 13, {x:-445}, {x:-15, ease:Linear.easeNone}, '0');
}
function restart() {
  tl1.restart();
  tl2.restart();
