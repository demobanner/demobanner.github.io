 ...
 */
function init() {
  Enabler.setExpandingPixelOffsets(300, 0, 600, 260);
...
function init1() {
  tl1.to(f2_text1, 0.5, {autoAlpha:1, ease:Power3.easeInOut})
    ...
    .fromTo(f3_car1, 0.5, {autoAlpha:1, x:-220, y:-20}, {x:40, y:0, ease:Power1.easeInOut})
    ...
    .fromTo(f7_car1, 0.5, {autoAlpha:1, x:-220, y:-24}, {x:0, y:-14, ease:Power1.easeOut})
    .to(wheels1, 0.1, {autoAlpha:0, ease:Power1.easeInOut}, "-=0.1")
  ...
  tl1.fromTo(stars1, 13, {x:-304}, {x:-71, ease:Linear.easeNone}, '0');
}
...
function init2() {
  tl2.to(f2_text2, 0.5, {autoAlpha:1, ease:Power3.easeInOut})
   ...
   .fromTo(f3_car2, 0.5, {autoAlpha:1, x:-250, y:-20}, {x:0, y:0, ease:Power1.easeInOut})
    ...
    .to(f3_car2, 0.5, {x:310, y:20, ease:Power1.easeInOut})
    ...
    .fromTo(f7_car2, 0.5, {autoAlpha:1,x:-250, y:-20}, {x:50,y:1, ease:Power1.easeOut})
    .to(wheels2, 0.1, {autoAlpha:0, ease:Power1.easeInOut}, "-=0.1")
  ...
  tl2.fromTo(stars2, 13, {x:-253}, {x:0, ease:Linear.easeNone}, '0');
}
function restart() {
  tl1.restart();
  tl2.restart();
