...
function init1() {
  tl1.to(f2_text1, 0.5, {autoAlpha:1, ease:Power3.easeInOut})
    ...
    .fromTo(f3_car1, 0.5, {autoAlpha:1, x:-300, y:-20}, {x:0, y:0, ease:Power1.easeInOut})
    ...
    .fromTo(f3_car1, 0.5, {autoAlpha:1, x:-300, y:-20}, {x:0, y:0, ease:Power1.easeOut})
    .to(wheels1, 0.1, {autoAlpha:0, ease:Power1.easeInOut}, "-=0.1")
...
function init2() {
  tl2.to(f2_text2, 0.5, {autoAlpha:1, ease:Power3.easeInOut})
   ...
   .fromTo(f3_car2, 0.5, {autoAlpha:1, x:-435, y:-20}, {x:0, y:0, ease:Power1.easeInOut})
    .to(wheels2, 0.1, {autoAlpha:0, ease:Power1.easeInOut}, "-=0.1")
    .to(wheels2, 0.1, {autoAlpha:1, ease:Power1.easeInOut}, "+=1")
    .to(f3_car2, 0.5, {x:600, y:20, ease:Power1.easeInOut})
    ...
    .fromTo(f7_car2, 0.5, {autoAlpha:1, scale:0.9, x:-600, y:-53}, {x:0,y:-33, ease:Power1.easeOut})
    .to(wheels2, 0.1, {autoAlpha:0, ease:Power1.easeInOut}, "-=0.1")
  ...
  tl2.fromTo(stars2, 13, {x:-340}, {x:10, ease:Linear.easeNone}, '0');
}
function restart() {
  tl1.restart();
  tl2.restart();
