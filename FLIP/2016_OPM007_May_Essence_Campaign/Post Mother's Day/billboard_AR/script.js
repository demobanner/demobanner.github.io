...
pageLoadedHandler = function(){
  ...
  mainExit1       = document.getElementById('mainExit1');
  mainExit2       = document.getElementById('mainExit2');
...
addListeners = function (){
  ...
  mainExit1.addEventListener('click', onMainExit1Handler, false);
  mainExit2.addEventListener('click', onMainExit2Handler, false);
}
...
function animations() {
  ...
  bannerTween.to(bracelet1, 0.5, {autoAlpha: 1, scale: 1, ease: Power0.easeOut})
             ...
             .to(cta, 0.5, {autoAlpha: 1, left: 0, ease: Power0.easeOut})
             .to(charm1, 0.5, {autoAlpha: 0}, "+=2")
             .to(charm2, 0.5, {autoAlpha: 1})
             .to(charm2, 0.5, {autoAlpha: 0}, "+=2")
             .to(charm3, 0.5, {autoAlpha: 1})
             .to([bracelet1, charm3, text, cta], 0.5, {autoAlpha: 0}, "+=3");
  bannerTween.to(mainExit1, 0.5, {display:'none'})
             .to(bracelet, 0.5, {autoAlpha: 1, scale: 1, ease: Power0.easeOut})
             .to(text1, 0.5, {autoAlpha: 1, top: 0})
             .to(cta1, 0.5, {autoAlpha: 1, left: 0, ease: Power0.easeOut})
