...
function init() {
    ...
    var bannerTween = new TimelineLite();
      	...
      	bannerTween.to(text1, 0.5, {autoAlpha: 1, ease: Power2.easeInOut})
              ...
              .to(text1, 0.2, {scale: 1.2, top: 40})
              .to(text1, 0.2, {scale: 1, top: 0})
              .to(cup1, 0.3, {left: 0, ease: Power2.easeInOut}, '-=0.2')

              .to(bg2, 0.5, {height: 430, ease: Power2.easeOut})
              .to(text2, 0.5, {top: 20, ease: Power2.easeOut}, '-=0.5')
              ...
              .to(bg2, 0.3, {height: 410, ease: Power2.easeOut}, '-=0.3')
              .to(tea, 0.3, {top: -103, ease: Power2.easeOut}, '-=0.3')
