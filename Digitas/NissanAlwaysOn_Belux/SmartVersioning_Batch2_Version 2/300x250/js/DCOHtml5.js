    ...
    DCOHtml5.prototype = {
        ...
        init: function() {
            ...
            this.f1_subtitle_color                  = this.f1_subtitle_css_array[0];
            this.f1_subtitle_size                   = this.f1_subtitle_css_array[1];
            this.f1_subtitle_left                   = this.f1_subtitle_css_array[2];
            this.f1_subtitle_top                    = this.f1_subtitle_css_array[2];
            this.f1_subtitle_span_color             = this.f1_subtitle_css_array[3];
            ...
            this.f1_subtitle_animate_color          = this.f1_subtitle_animate_array[0];
            this.f1_subtitle_animate_size           = this.f1_subtitle_animate_array[1];
            this.f1_subtitle_animate_left           = this.f1_subtitle_animate_array[2];
            this.f1_subtitle_animate_top            = this.f1_subtitle_animate_array[2];
            this.f1_subtitle_animate_span_color     = this.f1_subtitle_animate_array[3];
            ...
            this.f2_subtitle_animate_color          = this.f2_subtitle_animate_array[0];
            this.f2_subtitle_animate_size           = this.f2_subtitle_animate_array[1];
            this.f2_subtitle_animate_left           = this.f2_subtitle_animate_array[2];
            this.f2_subtitle_animate_top            = this.f2_subtitle_animate_array[2];
            this.f2_subtitle_animate_span_color     = this.f2_subtitle_animate_array[3];
            ...
            this.f3_subtitle_animate_color          = this.f3_subtitle_animate_array[0];
            this.f3_subtitle_animate_size           = this.f3_subtitle_animate_array[1];
            this.f3_subtitle_animate_left           = this.f3_subtitle_animate_array[2];
            this.f3_subtitle_animate_top            = this.f3_subtitle_animate_array[2];
            this.f3_subtitle_animate_span_color     = this.f3_subtitle_animate_array[3];
